...
export const fetchParentCategories = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/product-categories/parents`);
    return response.data;
  } catch (error) {
...
export const fetchSubcategories = async (categoryId) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/product-categories/${categoryId}/subcategories`);
...
export const fetchProductsByCategory = async (categoryName) => {
  const response = await fetch(`${API_BASE_URL}/products/by-category/${categoryName}`);
...
export const getYouMayAlsoLikeProducts = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/homepage/you-may-also-like`);
    return response.data; // Extracting 'data' from the response
  } catch (error) {
